...
type TransitionService interface {
	Transition(ctx context.Context, processInstanceID *string, entityID, processCode, action string, comment *string, documents []models.Document, assignees *[]string, tenantID string) (*models.ProcessInstance, error)
}
