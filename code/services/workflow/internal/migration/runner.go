...
func (r *Runner) acquireLock() error {
	_, err := r.db.Exec("SELECT pg_advisory_lock(123456789)")
	return err
}
...
func (r *Runner) getAppliedMigrations() (map[string]*Migration, error) {
	query := "SELECT version, name, applied_at, checksum FROM workflow_migrations"
...
func (r *Runner) executeMigration(migration *Migration) error {
	...
	query := `
		INSERT INTO workflow_migrations (version, name, applied_at, checksum)
		VALUES ($1, $2, $3, $4)`
